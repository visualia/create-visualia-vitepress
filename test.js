// node_modules/vitepress/node_modules/@vue/shared/dist/shared.esm-bundler.js
...
// node_modules/vitepress/node_modules/@vue/reactivity/dist/reactivity.esm-bundler.js
...
// node_modules/vitepress/node_modules/@vue/runtime-core/dist/runtime-core.esm-bundler.js
var stack = [];
...
// node_modules/vitepress/node_modules/@vue/runtime-dom/dist/runtime-dom.esm-bundler.js
...
// node_modules/visualia/dist/visualia.es.js
...
function hexToRgba(hexValue) {
  ...
  var rgb2 = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(hex);
...
(function(module, exports) {
  (function webpackUniversalModuleDefinition(root, factory) {
    ...
    return function() {
      ...
      var uppercase = /([A-Z])/g;
      var hyphenate2 = function hyphenate22(str) {
      ...
      var Settings = function() {
        function Settings2(options) {
          ...
          options = options || {};
          this.displayMode = utils2.deflt(options.displayMode, false);
          this.output = utils2.deflt(options.output, "htmlAndMathml");
          this.leqno = utils2.deflt(options.leqno, false);
          this.fleqn = utils2.deflt(options.fleqn, false);
          this.throwOnError = utils2.deflt(options.throwOnError, true);
          this.errorColor = utils2.deflt(options.errorColor, "#cc0000");
          this.macros = options.macros || {};
          this.minRuleThickness = Math.max(0, utils2.deflt(options.minRuleThickness, 0));
          this.colorIsTextColor = utils2.deflt(options.colorIsTextColor, false);
          this.strict = utils2.deflt(options.strict, "warn");
          this.trust = utils2.deflt(options.trust, false);
          this.maxSize = Math.max(0, utils2.deflt(options.maxSize, Infinity));
          this.maxExpand = Math.max(0, utils2.deflt(options.maxExpand, 1e3));
          this.globalGroup = utils2.deflt(options.globalGroup, false);
        }
        ...
        _proto.isTrusted = function isTrusted(context) {
          if (context.url && !context.protocol) {
            context.protocol = utils2.protocolFromUrl(context.url);
          }
      ...
      var Style = function() {
        function Style2(id, size2, cramped) {
          this.id = void 0;
          this.size = void 0;
          this.cramped = void 0;
          this.id = id;
      ...
      var SvgNode = function() {
        ...
        _proto5.toNode = function toNode() {
          ...
          var node = document.createElementNS(svgNS2, "svg");
          for (var attr in this.attributes) {
      ...
      var PathNode = function() {
        ...
        _proto6.toNode = function toNode() {
          var svgNS2 = "http://www.w3.org/2000/svg";
          var node = document.createElementNS(svgNS2, "path");
          if (this.alternate) {
      ...
      var LineNode = function() {
        ...
        _proto7.toNode = function toNode() {
          var svgNS2 = "http://www.w3.org/2000/svg";
          var node = document.createElementNS(svgNS2, "line");
          for (var attr in this.attributes) {
            if (Object.prototype.hasOwnProperty.call(this.attributes, attr)) {
              node.setAttribute(attr, this.attributes[attr]);
            }
      ...
      var MathNode = function() {
        ...
        _proto.getAttribute = function getAttribute2(name) {
      ...
      var getVariant = function getVariant2(group, options) {
        ...
        var text = group.text;
        if (utils2.contains(["\\imath", "\\jmath"], text)) {
          return null;
        }
      ...
      var makeStackedDelim = function makeStackedDelim2(delim, heightTotal, center, options, mode, classes) {
        ...
        var stack2 = [];
        stack2.push(makeGlyphSpan(bottom, font, mode));
        stack2.push(lap);
        if (middle === null) {
          var innerHeight = realHeightTotal - topHeightTotal - bottomHeightTotal + 2 * lapInEms;
          stack2.push(makeInner(repeat, innerHeight, options));
        } else {
          var _innerHeight = (realHeightTotal - topHeightTotal - bottomHeightTotal - middleHeightTotal) / 2 + 2 * lapInEms;
          stack2.push(makeInner(repeat, _innerHeight, options));
          stack2.push(lap);
          stack2.push(makeGlyphSpan(middle, font, mode));
          stack2.push(lap);
          stack2.push(makeInner(repeat, _innerHeight, options));
        }
        stack2.push(lap);
        stack2.push(makeGlyphSpan(top, font, mode));
      ...
      defineFunction({
        ...
        handler: function handler(_ref2, args) {
          var parser = _ref2.parser;
          var body = args[0];
          var isCharacterBox2 = utils2.isCharacterBox(body);
          return {
            type: "mclass",
            mode: parser.mode,
      ...
      defineFunctionBuilders({
        ...
        htmlBuilder: function htmlBuilder2(group, options) {
          ...
          var supShift = 0;
          var subShift = 0;
          var isCharacterBox2 = valueBase && utils2.isCharacterBox(valueBase);
          if (valueSup) {
            var newOptions = options.havingStyle(options.style.sup());
      ...
      var Namespace = function() {
        ...
        _proto.set = function set2(name, value, global2) {
          if (global2 === void 0) {
            global2 = false;
          }
          if (global2) {
...
var _sfc_main$1 = defineComponent({
  ...
  setup(__props) {
    ...
    if (slots && slots.default) {
      watch(() => slots.default(), (nodes) => {
        const node = nodes[0].children;
        math.value = katex$1.exports.renderToString(String.raw`${node}`, {
          throwOnError: false
        });
      }, { immediate: true });
    }
    return (_ctx, _cache) => {
      return openBlock(), createBlock("span", { innerHTML: math.value }, null, 8, ["innerHTML"]);
    };
  }
});
var __glob_3_1 = Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": _sfc_main$1
});
var _sfc_main = defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    watch(() => state[stateKey], () => {
      emit("update:modelValue", state[stateKey]);
    }, { immediate: true });
    return (_ctx, _cache) => {
      return withDirectives((openBlock(), createBlock("input", {
        type: "range",
        "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(state)[unref(stateKey)] = $event)
      }, null, 512)), [
        [
          vModelText,
          unref(state)[unref(stateKey)],
          void 0,
          { number: true }
        ]
      ]);
...
function chunk(arr, length) {
  return Array.from({ length: Math.ceil(arr.length / length) }).map((_, n) => arr.slice(n * length, n * length + length));
}
function rgba(r, g, b, a = 1) {
  return `rgba(${r},${g},${b},${a})`;
}
var rgb = rgba;
function hsla(h2, s, l, a = 1) {
  return `hsla(${h2},${s}%,${l}%,${a})`;
}
var hsl = hsla;
function hue(h2) {
  return hsla(h2, 100, 50, 1);
}
function gray(value) {
...
function rotate(angle = 0, x, y) {
  return `rotate(${angle},${x || 0},${y || 0})`;
}
function scale(scaleX = 1, scaleY) {
  return `scale(${scaleX} ${scaleY || scaleX})`;
}
function skewX(angle = 0) {
  return `skewX(${angle})`;
}
function skewY(angle = 0) {
  return `skewY(${angle})`;
}
...
var componentFiles = { "./components/VAnimate.vue": __glob_3_0, "./components/VMath.vue": __glob_3_1, "./components/VSlider.vue": __glob_3_2 };
var components = Object.fromEntries(Object.entries(componentFiles).map(([path, component]) => {
  return [
...
var Visualia = {
  install: (app) => {
    ...
    app.config.globalProperties.get = (key, def2) => {
      var _a, _b;
      return (_b = (_a = state == null ? void 0 : state[key]) != null ? _a : def2) != null ? _b : void 0;
    };
    app.config.globalProperties.set = (key, value) => {
      state[key] = value;
    };
    Object.entries(utils).forEach(([name, util]) => app.config.globalProperties[name] = util);
...
//# sourceMappingURL=visualia.js.map
